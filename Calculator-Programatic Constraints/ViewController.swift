...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for index in 0...9 {
            ...
            button.addTarget(self, action: #selector(operate), forControlEvents: .TouchUpInside)
        ...
        buttonDivide.addTarget(self, action: #selector(operate), forControlEvents: .TouchUpInside)
        ...
        buttonMultiply.addTarget(self, action: #selector(operate), forControlEvents: .TouchUpInside)
        ...
        buttonSubtract.addTarget(self, action: #selector(operate), forControlEvents: .TouchUpInside)
        ...
        buttonAddition.addTarget(self, action: #selector(operate), forControlEvents: .TouchUpInside)
        view.addSubview(buttonAddition)
        
        let buttonEquals = UIButton()
        buttonEquals.layer.borderWidth = 0.5
        buttonEquals.layer.borderColor = UIColor.cyanColor().CGColor
        buttonEquals.backgroundColor = UIColor.blueColor()
        ...
        buttonEquals.addTarget(self, action: #selector(enter), forControlEvents: .TouchUpInside)
